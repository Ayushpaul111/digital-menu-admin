...
import { Search, Filter, Star, Loader2, X, Edit3 } from "lucide-react";
...
const EditModal = memo(({ item, isOpen, onClose, onSave }) => {
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        setSubmitError(`Failed to update item: ${error.message}`);
      } finally {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 text-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                required
              />
            </div>
